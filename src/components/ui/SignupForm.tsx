                    ...
                    if (fieldError.path && fieldError.path in form.getValues()) {
                      ...
                      if (
                        ...
                        (errorMsg.includes('already registered') ||
                          ...
                          errorMsg.includes('must be unique') ||
                          errorMsg.includes('value must be unique'))
                      ) {
                        userFriendlyMessage =
    ...
    <section className={cn('max-w-md mx-auto relative')}>
      {success ? (
        <div className="text-center space-y-4">
          ...
          <div className="space-y-2">
            <p className="text-gray-600">
              We&apos;ve sent a verification email to your address. Please check your inbox and
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-4">
              <div className="flex items-start space-x-3">
                ...
                <div className="text-sm text-blue-700">
                  <p>
                    <strong>Important:</strong> You won&apos;t be able to log in until you verify
                    your email address. If you don&apos;t see the email, check your spam folder.
                  </p>
                </div>
              </div>
            </div>
        ...
        <>
          ...
          {error && (
            <MessageAlert
              message={'An error occurred. Review the fields below and try again.'}
              type="error"
            />
          )}
          <Form {...form}>
